    ...
    class PluginEditorWindow : public juce::DocumentWindow {
      public:
        PluginEditorWindow(const juce::String &title, int pluginIndex, PluginChainComponent &parent)
            : DocumentWindow(title, juce::Colours::darkgrey, DocumentWindow::allButtons), slotIndex(pluginIndex),
              parentComponent(parent) {
            setUsingNativeTitleBar(true);
            setResizable(true, true);
        }

        void closeButtonPressed() override { parentComponent.onEditorWindowClosed(slotIndex); }
